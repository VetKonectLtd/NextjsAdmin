...
interface BlogState {
    ...
    flagBlog: (id: number, flag: BlogFlagType) => Promise<void>;
}
...
export const useBlogStore = create<BlogState>((set, get) => ({
    ...
    fetchDeletedBlogs: async () => {
        ...
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Failed to fetch deleted blogs';
            set({ error: errorMessage, isLoading: false });
    ...
    restoreBlog: async (id: number) => {
        ...
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Failed to restore blog';
            set({ error: errorMessage, isLoading: false });
    ...
    archiveBlog: async (id: number) => {
        ...
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Failed to archive blog';
            set({ error: errorMessage, isLoading: false });
    ...
    rejectBlog: async (id: number) => {
        ...
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Failed to reject blog';
            set({ error: errorMessage, isLoading: false });
    ...
    flagBlog: async (id: number, flag: BlogFlagType) => {
        set({ isLoading: true, error: null });
        try {
            await blogService.flagBlog(id, { flag });
            set({ isLoading: false });
            toast.success(`Blog flagged as ${flag}`);
            await get().fetchBlogs();
        } catch (error: unknown) {
            const errorMessage = error instanceof Error ? error.message : 'Failed to flag blog';
            set({ error: errorMessage, isLoading: false });

                ...
                {mockPetsAndFarms.map((item) => (
                    ...
                    >
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-500">{item.typeId}</p>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-xs text-gray-400">{item.lastActive}</span>
                        </div>
                    </div>
                ))}
            </div>

...
const mockUsers = [
    ...
    {
        id: 5,
        name: "Uzochi Chigozie",
        role: "Animal Owner",
        avatar: "UC",
        status: "enabled",
        lastActive: "Sun 26, March 2023 12:42 PM CST",
    },
];

export function AnimalOwners() {
                ...
                {mockUsers.map((user) => (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4">
                            <Button
                                variant={user.status === "enabled" ? "default" : "destructive"}
                                className={
                                    user.status === "enabled"
                            ...
                            >
                                {user.status === "enabled" ? "Enable" : "Disable"}
                            </Button>
